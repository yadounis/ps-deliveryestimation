 ...
 * shoppingCart.tpl
 *
 * File to display estimations in cart summary page
 *
 ...
 * @since      File available since Release 1.0.0
 ...
 <div id="deliveryestimation">
	<a href="#deliveryestimation_modal" class="open_model"><img src="/modules/deliveryestimation/views/img/cart_delivery.png"><span>{$cart_page_link_text}</span></a>
	<div id="deliveryestimation_modal">
		<div id="cart_page_first_paragraph">{$cart_page_first_paragraph}</div>
		<div id="deliveryestimation_content">
			<form id="deliveryestimation_form">
				...
				<select id="deliveryestimation_zone" name="deliveryestimation_zone" data-type="order">
		...
		<div id="cart_page_second_paragraph">{$cart_page_second_paragraph}</div>
	</div>
</div>